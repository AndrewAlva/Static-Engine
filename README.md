...
It contains some pre-built UI modules for faster development.

Currently more focused on single pages, but still useful for multiple pages websites.

## Pre-Built UI components
### 1, Header Nav (simple)
* Layout with "Logo" and "Burger menu"
...
* SCSS for CSS files.
* Brunch will take care of compiling all js files placed in `js` folder into a single file, minify and uglify it.
...
To use this boilerplate you must install npm and brunch in your computer. The coded is oriented to use "modules" and "objects" of HTML and CSS with Jade and SCSS. The JS syntax you will find in default files is ES5 (ECMAScript5).
